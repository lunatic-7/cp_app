  ...
  return (
    <Modal transparent visible animationType="fade" onRequestClose={close}>
      <View style={styles.overlay}>
        ...
        <Animated.View style={[styles.sheet, { paddingTop: Math.max(insets.top + 18, 46), paddingBottom: insets.bottom, backgroundColor: colors.surface, transform: [{ translateX }] }]}>
...
const styles = StyleSheet.create({
  ...
  sheet: { width: SHEET_WIDTH, height: "100%", borderTopLeftRadius: 28, borderBottomLeftRadius: 28 },
  ...
  closeText: { fontSize: 20, lineHeight: 23, fontWeight: "800" }, list: { paddingHorizontal: 18, paddingBottom: 40 },
